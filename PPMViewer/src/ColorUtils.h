...
namespace ColorUtils {
	...
	void RGBAtoColorChannels(uint8_t* buffer, uint32_t rgba)
	{
	...
	void RGBAtoVec4(glm::vec4& ve, uint32_t rgba)
	{
	...
	void RGBAtoVec3(glm::vec3& ve, uint32_t rgba)
	{
		//ve.a = (float)((rgba & 0xFF000000) >> 0x18) / 255.0f;
		ve.b = (float)((rgba & 0x00FF0000) >> 0x10) / 255.0f;
		ve.g = (float)((rgba & 0x0000FF00) >> 0x08) / 255.0f;
	...
	void RGBAtoColorFloats(float* buffer, uint32_t rgba)
	{
	...
	uint8_t GetAlphaChannel(uint32_t rgba)
	{
		return (uint8_t)((rgba & 0xFF000000) >> 0x18);
	}

	uint8_t GetBlueChannel(uint32_t rgba)
	{
		return (uint8_t)((rgba & 0x00FF0000) >> 0x10);
	}

	uint8_t GetGreenChannel(uint32_t rgba)
	{
		return (uint8_t)((rgba & 0x0000FF00) >> 0x08);
	}

	uint8_t GetRedChannel(uint32_t rgba)
	{
		return (uint8_t)((rgba & 0x000000FF));
	}


	void SetAlphaChannel(uint32_t* rgba, uint8_t a)
	{
		(*rgba) = ((*rgba) & 0x00FFFFFF) | a << 0x18;
	}

	void SetBlueChannel(uint32_t* rgba, uint8_t b)
	{
		(*rgba) = ((*rgba) & 0xFF00FFFF) | b << 0x10;
	}

	void SetGreenChannel(uint32_t* rgba, uint8_t g)
	{
		(*rgba) = ((*rgba) & 0xFFFF00FF) | g << 0x08;
	}

	void SetRedChannel(uint32_t* rgba, uint8_t r)
	{
		(*rgba) = ((*rgba) & 0xFFFFFF00) | r;
	}

	void SetColorChannel(uint32_t* rgba, uint16_t r = KeepColorChannel, uint16_t g = KeepColorChannel, uint16_t b = KeepColorChannel, uint16_t a = KeepColorChannel)
	{
