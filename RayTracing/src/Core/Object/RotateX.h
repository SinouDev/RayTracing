...
class RotateX : public HittableObject
{
public:

	RotateX(std::shared_ptr<HittableObject>& object, float angle = 0.0f);
	...
	virtual inline HittableObjectTypes GetType() const override { return HittableObjectTypes::ROTATE_X; }
