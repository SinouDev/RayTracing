...
public:
	...
	virtual inline HittableObjectTypes GetType() const override { return HittableObjectTypes::BVH_NODE; }

	inline HittablePtr& GetLeft() { return m_Left; }
	inline HittablePtr& GetRight() { return m_Right; }
