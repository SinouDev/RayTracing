...
public:
	...
	XzRect();
	XzRect(const Utils::Math::Mat2x2& pos, float k, const std::shared_ptr<Material>& material);
	...
	virtual inline HittableObjectTypes GetType() const override { return HittableObjectTypes::XZ_RECT; }
