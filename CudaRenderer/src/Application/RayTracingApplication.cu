...
using ImGui::Helper::ColorEdit3;
using ImGui::Helper::HelpMarker;
using ImGui::Helper::DragInt;
using ImGui::Helper::SliderInt;
using ImGui::Helper::DragFloat;
using ImGui::Helper::DragFloat2;
using ImGui::Helper::DragFloat3;
using ImGui::Helper::SliderFloat;
using ImGui::Helper::TreeNode;
using ImGui::Helper::DisablableTreeNode;
...
void RayTracingLayer::SavePPM(const char* path)
{
	//m_Renderer.SaveAsPPM(path);
	m_CudaRenderer.SaveAsPPM(path);
}

void RayTracingLayer::SavePNG(const char* path)
{
...
void RayTracingLayer::InitImGuiStyle()
{
