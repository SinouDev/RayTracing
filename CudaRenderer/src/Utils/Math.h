...
namespace Utils {
	...
	namespace Math {
		...
		static __forceinline Mat4 PerspectiveFov(float fov, float width, float height, float nearClicp, float farClicp)
		{
			return glm::perspectiveFov(fov, width, height, nearClicp, farClicp);
		}
